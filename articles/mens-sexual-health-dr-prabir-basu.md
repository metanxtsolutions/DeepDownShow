---
{
  "video_id": "7yLfZnfdTMI",
  "video_title": "Sex নিয়ে বাংলা podcast - Male Real life Issues, Unhealthy Practices & Their Solutions | DDS 22",
  "episode": 22,
  "slug": "mens-sexual-health-dr-prabir-basu",
  "title": "Dr Prabir Basu on Men's Sexual Health: ED, Viagra, NoFap",
  "title_bn": "পুরুষের যৌন স্বাস্থ্য: ডা. প্রবীর বসুর সঙ্গে খোলামেলা কথা",
  "meta_description": "Kolkata andrologist Dr Prabir Basu on erectile dysfunction, masturbation myths, Viagra misuse, varicocele and NoFap — the talk Bengali men avoid.",
  "lede": "Kolkata urologist and andrologist Dr. Prabir Basu tells Barun why Bengali men suffer in silence — and what performance anxiety, NoFap, Viagra and varicocele actually do.",
  "guest": "Dr. Prabir Basu",
  "guest_role": "Urologist, andrologist and uro-oncologist, Kolkata",
  "category": "society",
  "published": "2025-11-22",
  "duration": "1:10:05",
  "keywords": ["men's sexual health", "Dr Prabir Basu", "andrologist Kolkata", "erectile dysfunction", "premature ejaculation", "masturbation good or bad", "NoFap semen retention", "varicocele", "Viagra side effects", "sex education", "যৌন শিক্ষা", "পুরুষের যৌন সমস্যা", "হস্তমৈথুন", "বাংলা পডকাস্ট"],
  "takeaways": [
    "Dr. Basu says most young men who come to him with erectile dysfunction have a psychological cause — performance anxiety — not a physical one.",
    "Viagra began as a Pfizer heart medicine; Basu warns it still acts on the heart and should only be taken under supervision, never in escalating doses copied from friends.",
    "Nightfalls are normal, says Basu: retained secretions press on the prostate and can cause chronic prostatitis, so the body clears them.",
    "Masturbation is not harmful if done properly, but prone masturbation and hurried 'hand-grip' habits can train the body for the wrong stimulus and cause premature ejaculation.",
    "Fathers should check their sons for tight phimosis, and every man should check in the mirror for a low-hanging, rope-like left testis — the sign of varicocele.",
    "Erectile dysfunction at 30–33 can precede heart disease by about ten years, because the penile artery is far narrower than the coronary artery.",
    "Sleep of 7–8 hours, protein and healthy fats, resistance training, and avoiding plastic bottles and cola do more for testosterone than any supplement or injection."
  ],
  "faq": [
    {"q": "Is masturbation good or bad, according to Dr. Prabir Basu?", "a": "Basu says the question is hard to answer on a public platform, but his position is that masturbation is not bad if done properly, and that if you have a partner you don't need it. It becomes harmful when it is tied to addiction, injures penile tissue, or trains the body for the wrong stimulus — as in prone masturbation against a pillow or the hurried 'hand-grip' habit that later shows up as premature ejaculation."},
    {"q": "Are nightfalls harmful?", "a": "No, according to Basu. He uses the analogy of a breastfeeding mother who stops feeding for a few days and still leaks milk: the body produces secretions, and if they are stored they press on the prostate and can cause chronic prostatitis, with testicular and anal pain and burning on urination. Nightfalls, even three a week in a teenager, are the body doing its normal job."},
    {"q": "Why does Dr. Basu warn against taking Viagra without a prescription?", "a": "Because it was designed as a heart drug. He tells the story of Pfizer's vasodilator for cardiac patients that turned out to increase penile blood flow, and of two friends who shared a girlfriend and escalated from 100 mg to 400 mg until one arrived with chest pain. The starting dose is 25 mg, chemists routinely hand out 100, and the drug acts on the heart of a 20-year-old just as it does on a 60-year-old's."},
    {"q": "What is varicocele and how can a man check for it?", "a": "Varicocele is dilation of the veins draining the testis, which Basu now sees in many men aged 20 to 25 with testicular pain. He blames long hours on vibrating motorbikes, heavy deadlifts and squats without support, and chronic straining on the toilet. His self-check: stand before a mirror, see whether the left testis hangs clearly lower than the right, and feel for a rope-like texture above it. Untreated, he says, it can reduce testosterone and sperm production and end in infertility."},
    {"q": "What does Dr. Basu recommend for raising testosterone naturally?", "a": "Lower belly fat, because waist fat converts testosterone to oestrogen; raise protein and healthy fats (ghee, good paneer, whey, fish, meat, eggs) and cut carbohydrates; do resistance training, which raises growth hormone; sleep seven to eight hours; fix the circadian rhythm if you work nights; and avoid plastic bottles, microwaved plastic containers and cola. He is firmly against testosterone injections."},
    {"q": "When should a couple trying to conceive have sex most often?", "a": "In the middle of the menstrual cycle, Basu says. His example: if a period ended on 31 March and the cycle is 24 days, days 10 to 12 are when ovulation is highest. More eggs meeting more sperm raises the chance of pregnancy, so frequency should be concentrated then — especially for couples where erectile dysfunction and infertility have run together for years."},
    {"q": "Is this episode's advice a substitute for seeing a doctor?", "a": "No. The episode reports one doctor's remarks in an unscripted conversation, and Basu himself repeatedly tells listeners not to self-medicate from Google, ChatGPT, chemist counters or roadside phone numbers. If any of the problems described sound familiar, his advice is to see an andrologist or urologist."}
  ],
  "related": ["mens-rights-nandini-bhattacharjee-marriage-law", "self-defence-martial-arts-gourav-banerjee", "karimul-haque-bike-ambulance-dada", "3d-printing-organ-printing"],
  "clips": [
    {"id": "4cFJIUzgpaA", "title": "Masturbation: right or wrong? A urologist answers"},
    {"id": "NkO_64fT4uI", "title": "What is varicocele? Cause and cure"},
    {"id": "F7wu1XiWPqo", "title": "Best time to have sex to fight infertility?"},
    {"id": "5RNLMJeFcLI", "title": "Why was Viagra actually invented?"},
    {"id": "cRrMlxN-DOQ", "title": "Sex education should start from home"},
    {"id": "RF6dVsKKCV0", "title": "Semen retention and NoFap for athletes"},
    {"id": "MTEw-XPLyGU", "title": "Performance issues in bed"},
    {"id": "Ohxn7ls0AHE", "title": "Does size really matter?"},
    {"id": "NCgO7EJCqvE", "title": "Men don't talk about their sexual issues"},
    {"id": "JOAjJmtlIbY", "title": "Highlights of the episode"}
  ]
}
---
...
> আমরা লজ্জায় কিছু বলতে চাই না। কিন্তু আমরা সবাই এ নিয়ে খুবই ইন্টারেস্টেড, এক্সাইটেড এবং অ্যাক্টিভ। — Dr. Prabir Basu
...
> একটা ছেলের কাছে গিয়ে বলা যে মশাই আমার হচ্ছে না — সেটা যেন বুকের পাটা লাগে। — Dr. Prabir Basu
...
> এই ৩০-৩৩ বছরের ছেলেরা যদি ইরেক্টাইল ডিসফাংশনে ভোগে, দেখা গেছে ১০ বছর পরে হার্টেরও প্রবলেম দেখা দিচ্ছে। — Dr. Prabir Basu
...
Barun asks the question his audience most wants answered: হস্তমৈথুন, masturbation — good or bad? Basu says outright that this is the hardest thing to say on a public platform. Subscribers' parents are watching; he once said "once a week" on another podcast and the comments called him a bad doctor.
...
- **NoFap at 14.** Boys of 14 and 15 come to him — one 12-year-old came with a friend and asked to talk without parents, which Basu refused, because they are adolescents — saying their friends have agreed to do NoFap but they are having nightfalls three times a week. At their age, Basu says, he did not know such a culture existed; now it arrives by Instagram reel.
...
> সেক্স এডুকেশনটা স্টার্টিং হবে হোম থেকে। — Barun

> নট অনলি সেক্স — সেক্সুয়াল অর্গান। হাউ টু কিপ ইট ক্লিন, হাউ টু কিপ ইট হেলদি। — Dr. Prabir Basu
...
> ২০ বছর আগে কেউ এই নিয়ে পডকাস্টই করেনি। দরকারই ছিল না। আজকে পডকাস্ট হচ্ছে, লোকে দেখছে, কারণ এখন দরকার আছে। — Dr. Prabir Basu
